...
$("#edit-event-cancel-ID").on("click", function() {
    // return to main-view
    event.preventDefault();
    $("#event-summary-input-ID, #event-description-input-ID").empty();

    setTimeSelectorsToMomentByID(moment().hour(9).minute(0), "#start-time-selectID");
    setTimeSelectorsToMomentByID(moment().hour(10).minute(0), "#end-time-selectID");
    $("#event-color-select-ID").val('green');
